...
OS_STK *OSTaskStkInit (void (*task)(void *p_arg), void *p_arg, OS_STK *ptos, INT16U opt)
{
   ...
   stk       = ptos + 1u;                       /* Load stack pointer                                   */
                                                /* Align the stack to 8-bytes.                          */
   stk       = (OS_STK *)((OS_STK)(stk) & 0xFFFFFFF8u);
                                                /* Registers stacked as if auto-saved on exception   */
   *(--stk)  = (INT32U)0x000000aa;              /* R? : argument                                      */
   *(--stk)  = (INT32U)0x0000000a;              /* FPSCR : argument                                   */
   *(--stk)  = (INT32U)0x00000015;              /* S15 : argument                                     */       
   *(--stk)  = (INT32U)0x00000014;              /* S14 : argument                                     */
   *(--stk)  = (INT32U)0x00000013;              /* S13 : argument                                     */
   *(--stk)  = (INT32U)0x00000012;              /* S12 : argument                                     */
   *(--stk)  = (INT32U)0x00000011;              /* S11 : argument                                     */
   *(--stk)  = (INT32U)0x00000010;              /* S10 : argument                                     */
   *(--stk)  = (INT32U)0x00000009;              /* S9 : argument                                      */
   *(--stk)  = (INT32U)0x00000008;              /* S8 : argument                                      */
   *(--stk)  = (INT32U)0x00000007;              /* S7 : argument                                      */        
   *(--stk)  = (INT32U)0x00000006;              /* S6 : argument                                      */       
   *(--stk)  = (INT32U)0x00000005;              /* S5 : argument                                      */
   *(--stk)  = (INT32U)0x00000004;              /* S4 : argument                                      */
   *(--stk)  = (INT32U)0x00000003;              /* S3 : argument                                      */
   *(--stk)  = (INT32U)0x00000002;              /* S2 : argument                                      */
   *(--stk)  = (INT32U)0x00000001;              /* S1 : argument                                      */
   *(--stk)  = (INT32U)0x00000000;              /* S0 : argument                                      */
   ...
   *(--stk)  = (INT32U)0x00000031uL;            /* S31                                                 */
   *(--stk)  = (INT32U)0x00000030uL;            /* S30                                                 */
   *(--stk)  = (INT32U)0x00000029uL;            /* S29                                                 */
   *(--stk)  = (INT32U)0x00000028uL;            /* S28                                                 */
   *(--stk)  = (INT32U)0x00000027uL;            /* S27                                                 */
   *(--stk)  = (INT32U)0x00000026uL;            /* S26                                                 */
   *(--stk)  = (INT32U)0x00000025uL;            /* S25                                                 */
   *(--stk)  = (INT32U)0x00000024uL;            /* S24                                                 */
   *(--stk)  = (INT32U)0x00000023uL;            /* S23                                                 */
   *(--stk)  = (INT32U)0x00000022uL;            /* S22                                                 */
   *(--stk)  = (INT32U)0x00000021uL;            /* S21                                                 */
   *(--stk)  = (INT32U)0x00000020uL;            /* S20                                                 */
   *(--stk)  = (INT32U)0x00000019uL;            /* S19                                                 */
   *(--stk)  = (INT32U)0x00000018uL;            /* S18                                                 */
   *(--stk)  = (INT32U)0x00000017uL;            /* S17                                                 */
   *(--stk)  = (INT32U)0x00000016uL;            /* S16 												  */
